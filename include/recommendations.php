                    ...
                    <div class="flip-container" ontouchstart="this.classList.toggle('hover')";>
                        <div class="flipper">
                            <div class="feature front">
                                ...
                                <h4><a href="https://www.linkedin.com/in/lymanwong" target="_blank">(See what Amanda had to say)</a></h4>
                            </div>
                            <div class="back">
                    ...
                    <div class="flip-container" ontouchstart="this.classList.toggle('hover');">
                        <div class="flipper">
                            <div class="feature front">
                                ...
                                <h4><a href="https://www.linkedin.com/in/lymanwong" target="_blank">(See what Max had to say)</a></h4>
                            </div>
                            <div class="back">
                    ...
                    <div class="flip-container" ontouchstart="this.classList.toggle('hover');">
                        <div class="flipper">
                            <div class="feature front">
                                ...
                                <h4><a href="https://www.linkedin.com/in/lymanwong" target="_blank">(See what Joe had to say)</a></h4>
                            </div>
                            <div class="back">
                    ...
                    <div class="flip-container" ontouchstart="this.classList.toggle('hover');">
                        <div class="flipper">
                            <div class="feature front">
                                ...
                                <h4><a href="https://www.linkedin.com/in/lymanwong/details/recommendations/?detailScreenTabIndex=0" target="_blank">(See what Josh had to say)</a></h4>
                            </div>
                            <div class="back">
                    ...
                    <div class="flip-container" ontouchstart="this.classList.toggle('hover');">
                        <div class="flipper">
                            <div class="feature front">
                                ...
                                <h4><a href="https://www.linkedin.com/in/lymanwong/details/recommendations/?detailScreenTabIndex=0" target="_blank">(See what Eric had to say)</a></h4>
                            </div>
                            <div class="back">
                    ...
                    <div class="flip-container" ontouchstart="this.classList.toggle('hover');">
                        <div class="flipper">
                            <div class="feature front">
                                ...
                                <h4><a href="https://www.linkedin.com/in/lymanwong/details/recommendations/?detailScreenTabIndex=0" target="_blank">(See what Amber had to say)</a></h4>
                            </div>
                            <div class="back">
